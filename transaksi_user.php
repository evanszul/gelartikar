...
<div class="container bg-white">
  <div class="row">
      <div class="box-kategori">
        <span class="judul-kategori"> Transaksi Pembelian</span>
      </div>
      <div class="breadcrumb">
        <span> <a href=""> Beranda </a> </span> /
        <span class="breadcrumb-active"> <a href="#"> Transaksi pembelian </a></span>
      </div>
  </div>
  <div class="row">
      <div class="col3">
      ...
      <div class="col9">
        <div class="box-transaksi">
          <div class="box-transaksi-header">
            <div class="col4">
              <span class="transaksi-font"> No Transaksi</span><br>
              GT17112W4BRHINV
            </div>
            <div class="col3">
            <span class="transaksi-font">   Total Bayar</span><br>
              Rp 95000
            </div>
            <div class="col3">
              <span class="transaksi-font"> Status</span><br>
              Terbayarkan
            </div>
            <div class="col2">
          ...
          <div class="box-transaksi-body">
            ...
            <div class="col2">
              <span class="transaksi-font">Kode Resi</span>
              819474230129487
            </div>
            <div class="col3">
              <a class="button button-transaksi pull-right" href="#">Beli Lagi</a>
            </div>
          </div>
      </div>
      <div class="box-transaksi">
